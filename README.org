...
|mesh generation:|external+predefined shapes|Yes, Constructive Solid Geometry (CSG) supported via mshr (CGAL and Tetgen used as backends)|No|Built-in|Built-in|
